...
*/
const dice = function () {
  let ex1 = Math.floor(Math.random() * 6) + 1;
  console.log(ex1);
};
dice();
...
*/
const deleteOne = function (string, isFirst) {
  if (isFirst) {
...
const isThisAnEmail = function () {
  ...
  let testEmails = ["prova.com", "teacher@epicode.com", "teacher @epicode.com"];
...
howManyDays();
console.log(howManyDays("2022-08-15"));
/* ESERCIZIO 10
  Scrivi una funzione chiamata "isTodayMyBirthday" che deve ritornare true se oggi è il tuo compleanno, falso negli altri casi.
*/
const isTodayMyBirthday = function () {
  const today = new Date();
  const birthday = new Date(today.getFullYear(), 4, 30);
...
// const countMovies = function (arr3) {
//   return arr3.length
...
// const onlyTheYears = function (arr4) {
//   let arrTitle = []
...
*/
const ex20 = function () {
  let sel = document.getElementById("container");
  console.log(sel);
};
/* ESERCIZIO 21
...
*/
const ex21 = function () {
  let sel = document.getElementsByTagName("td");
  console.log(sel);
};
...
*/
const ex23 = function () {
  let changeBg = (document.querySelectorAll("a").style.backgroundColor = "red");
...
const ex26 = function () {
  let addClass = (document.querySelectorAll("tr").className = "test");
